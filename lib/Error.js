...
class PaygloError extends Error {
  constructor(raw = {}) {
    super(raw.message);
    this.type = this.constructor.name;
  ...
  static generate(rawStripeError) {
    switch (rawStripeError.type) {
      ...
      case 'invalid_request_error':
        return new StripeInvalidRequestError(rawStripeError);
      case 'api_error':
        return new PaygloAPIError(rawStripeError);
      case 'authentication_error':
        return new StripeAuthenticationError(rawStripeError);
      case 'rate_limit_error':
        return new StripeRateLimitError(rawStripeError);
...
class PaygloAPIError extends StripeError {}
...
class PaygloAuthenticationError extends StripeError {}
...
class PaygloConnectionError extends StripeError {}
...
class PaygloSignatureVerificationError extends StripeError {}
...
module.exports.PaygloError = PaygloError;
...
module.exports.PaygloAPIError = PaygloAPIError;

module.exports.StripeAuthenticationError = StripeAuthenticationError;
module.exports.PaygloAuthenticationError = PaygloAuthenticationError;
...
module.exports.PaygloConnectionError = PaygloConnectionError;

module.exports.StripeSignatureVerificationError = StripeSignatureVerificationError;
module.exports.PaygloSignatureVerificationError = PaygloSignatureVerificationError;
