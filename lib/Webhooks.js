...
const {StripeError,PaygloError, StripeSignatureVerificationError,PaygloSignatureVerificationError} = require('./Error');
...
function parseEventDetails(encodedPayload, encodedHeader, expectedScheme) {
  ...
  if (!details || details.timestamp === -1) {
    throw new PaygloSignatureVerificationError({
  ...
  if (!signatureFound) {
    throw new PaygloSignatureVerificationError({
      message:
        ...
        ' Are you passing the raw request body you received from Payglo?' +
        ' https://www.npmjs.com/package/@juspay-tech/Payglo-node',
      detail: {
        header,
        payload,
      },
